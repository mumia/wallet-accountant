...
func TestNewReadCurrentAccountMonthApi(t *testing.T) {
	...
	mediator := ledgerquery.QueryMediatorMock{
		AccountMonthFn: func(
			ctx *gin.Context,
	...
	router := api.NewServer(
		[]definitions.Route{ledgerquery.NewReadCurrentAccountMonthApi(&mediator, logger)},
